...
class PointRCNNHead(RoIHeadTemplate):
    ...
    def roipool3d_gpu(self, batch_dict):
        ...
        batch_points = point_coords.view(batch_size, -1, 3).contiguous()
        batch_point_features = point_features_all.view(batch_size, -1, point_features_all.shape[-1]).contiguous()
